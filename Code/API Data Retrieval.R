...
# REC:  This code module retrieves data from the World Bank and UNDP sites via API calls,
# joins the data, displays it for proof and then saves it to an RDS file
#
...
# Turn the python code into a string for Reticulate and import the python 
...
print('Retrieving World Bank Data....this will take a while', flush=True)
...
print('Getting UNDP data for 2022/2023', flush=True)
...
print('Getting UNDP data for 2020/2021', flush=True)
...
print('Getting UNDP data for 2018/2019', flush=True)
...
print('Getting UNDP data for 2016/2017', flush=True)
...
print('Getting UNDP data for 2014/2015', flush=True)
...
print('Getting UNDP data for 2012/2013', flush=True)
...
print('Getting UNDP data for 2010/2011', flush=True)
...
# REC: Run the Python script in the embedded string via reticulate, and map to
# a dataframe
py_run_string(wb_undp_api_python_code)
wb_undp_df_r <- py$mapped_full_df

# Example of the python code turning into a dataframe that works with 
# tidyverse, etc.
glimpse(wb_undp_df_r)
head(wb_undp_df_r)
# REC 
# Save the dataframe into an .rds file to be imported into our cleaning/EDA module
saveRDS(wb_undp_df_r, file = here("Data","PreEDA_DataFrame.rds"))